...
import { DeclarationKind, Exportable, Exported, TypeDeclaration, TypeSpec } from './type-declaration';
 ...
 */
export class FreeFunction extends TypeDeclaration implements CallableDeclaration, Exportable, Exported {
