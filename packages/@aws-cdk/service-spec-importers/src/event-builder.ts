import { Service, SpecDatabase, Event, EventProperties } from '@aws-cdk/service-spec-types';
...
//   readonly properties: Record<string, Reference<Entity>>;
// }
//
...
export class SpecBuilder {
  ...
  private allocateResource(service: Service) {
    const resource = this.resourceDecider(service);
  ...
  private resourceDecider(service: Service) {
